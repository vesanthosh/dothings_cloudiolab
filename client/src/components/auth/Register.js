                            ...
                            <form noValidate onSubmit={this.onSubmit}>
                                <div className="form-group">
                                    <input type="text"
                                        className={classnames('form-control form-control-lg', {
                                            'is-invalid': errors.name // if the errors.name is exist then it will be called.
                                        })}
                                        placeholder="Name"
                                        name="name"
                                ...
                                <div className="form-group">
                                    <input className={classnames('form-control form-control-lg', {
                                        'is-invalid': errors.password2 // if the errors.name is exist then it will be called.
                                    })}
                                        type="password"
